...
@registerAbility()
export class antimage_ethereal_step extends BaseAbility
{
    ...
    OnSpellStart(): void {
        ...
        let range = this.GetEffectiveCastRange(position, caster);
        ...
        caster.AddNewModifier(caster, this, "modifier_antimage_ethereal_step", {duration: 1.5, x: position.x, y: position.y, z: position.z});

        caster.EmitSound("Hero_Antimage.Blink_out");
        caster.EmitSound("Hero_Antimage.Blink_in.Persona");
    }
}

@registerModifier()
export class modifier_antimage_ethereal_step extends BaseModifierMotionHorizontal
{
    position?: Vector;
    origin?: Vector;
...
@registerModifier()
export class modifier_antimage_ethereal_step_slow extends BaseModifier
{
    slow: number = 0;
    ...
    OnCreated(params: object): void {
        this.slow = -this.GetAbility()!.GetSpecialValueFor("shard_slow");
    }
